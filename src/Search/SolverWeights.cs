...
internal static class SolverWeights
{
    ...
    /// </summary>
    /// <remarks>
    /// Beam 和节点都要翻，翻一样多。历史实测（2026-09，极高档还是 50 000 节点的时期，当前四档为
    /// 60 000 / 120 000 / 250 000 / 500 000，数字只作量级参考）：只翻节点没用，Beam 90 的主搜索在
    /// 2 701–5 206 个节点上就把前沿走空了，花不掉多给的额度；只翻 Beam 也没用，Beam 135 找到胜利
