...
internal static class SolverDiagnostics
{
        ...
        SolverSearchProfile profile)
    {
        ...
        text.Append(Prefix).Append(" WEIGHTS")
            ...
            .Append(" sold_hp_tracking=cumulative_excess_loss")
    ...
    public static string DescribeResult(SolverResult result)
    {
        ...
        text.Append(Prefix).Append(" RESULT")
            ...
            .Append(" choice_branches_dropped_by_budget=")
            .Append(result.ChoiceBranchesDroppedByBudget)
            ...
            .Append(" execution_choice_captures=").Append(result.ExecutionChoiceCaptures)
            .Append(" execution_choice_reuses=").Append(result.ExecutionChoiceReuses)
            .Append(" card_prefix_attempts=").Append(result.CardChoicePrefixAttempts)
            .Append(" card_prefix_captures=").Append(result.CardChoicePrefixCaptures)
            .Append(" card_prefix_reuses=").Append(result.CardChoicePrefixReuses)
            .Append(" card_prefix_fallbacks=").Append(result.CardChoicePrefixFallbacks)
            .Append(" potion_prefix_forks=").Append(result.PotionChoicePrefixForks)
            .Append(" potion_prefix_captures=").Append(result.PotionChoicePrefixCaptures)
            .Append(" potion_prefix_reuses=").Append(result.PotionChoicePrefixReuses)
            .Append(" potion_prefix_fallbacks=").Append(result.PotionChoicePrefixFallbacks)
            ...
            .Append(" CycleReplayAttempts=").Append(result.CycleReplayAttempts)
            .Append(" CycleReplayActions=").Append(result.CycleReplayActions)
            .Append(" CycleReplayVictories=").Append(result.CycleReplayVictories)
            .Append(" CycleStoppedUnproductive=").Append(result.CycleStoppedUnproductive)
            .Append(" CycleStoppedRepetitionBudget=").Append(result.CycleStoppedRepetitionBudget)
            ...
            .Append(result.CycleRegionCandidatesConsidered)
            .Append(" cycle_region_admitted=").Append(result.CycleRegionCandidatesAdmitted)
            .Append(" cycle_region_dropped=").Append(result.CycleRegionCandidatesDropped)
            .Append(" cycle_region_progress_epochs=").Append(result.CycleRegionProgressEpochs)
            .Append(" cycle_region_probe_admitted=")
            .Append(result.CycleRegionProbeCandidatesAdmitted)
            .Append(" cycle_region_progress_admitted=")
            .Append(result.CycleRegionProgressCandidatesAdmitted)
            .Append(" cycle_region_max_action_families=")
            .Append(result.CycleRegionMaxActionFamilies)
            .Append(" ordered_admitted=").Append(result.OrderedMutationCandidatesAdmitted)
            .Append(" ordered_lease_expired_budget=")
            .Append(result.OrderedMutationLeaseExpiredBudget)
            .Append(" ordered_ordinary_fallback=")
            .Append(result.OrderedMutationOrdinaryFallbacks)
            .Append(" cold_atomic_committed=")
            .Append(result.OrderedMutationColdAtomicCommitted)
            .Append(" cold_atomic_rejected=")
            .Append(result.OrderedMutationColdAtomicRejected)
            ...
            .Append(" death_save_potion_hp=").Append(result.Snapshot.DeathSavePotionHpRestored)
            .Append(" death_save_uses=").Append(result.Snapshot.DeathSaveUseCount)
            .Append(" projected_death_save_uses=").Append(result.Snapshot.ProjectedDeathSaveUseCount)
    ...
    public static string DescribeSearchPhasePerformance(SolverResult result)
    {
        ...
        return new StringBuilder()
            ...
            .Append(" execution_resume=").Append(Metric(result.ExecutionChoiceResumeMetric))
