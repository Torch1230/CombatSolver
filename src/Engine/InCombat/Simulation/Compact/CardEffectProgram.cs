            ...
            switch (instruction.Kind)
            {
                ...
                case CardInstructionKind.ApplyBasicPower:
                    if (instruction.Target is not (CardInstructionTarget.Owner or CardInstructionTarget.ChosenEnemy or CardInstructionTarget.AllEnemies)
                        || instruction.Power is not (BasicPowerKind.Strength or BasicPowerKind.Dexterity or BasicPowerKind.Weak or BasicPowerKind.Poison or BasicPowerKind.ToolsOfTheTrade or BasicPowerKind.Neurosurge or BasicPowerKind.BorrowedTime or BasicPowerKind.Veilpiercer or BasicPowerKind.SpiritOfAsh or BasicPowerKind.DanseMacabre or BasicPowerKind.Lethality)
                        ...
                        || instruction.Power is BasicPowerKind.ToolsOfTheTrade or BasicPowerKind.Neurosurge or BasicPowerKind.BorrowedTime or BasicPowerKind.Veilpiercer or BasicPowerKind.SpiritOfAsh or BasicPowerKind.DanseMacabre or BasicPowerKind.Lethality && (instruction.Target != CardInstructionTarget.Owner
                            || instruction.Amount < 0 || instruction.EnergyXMultiplier != 0))
