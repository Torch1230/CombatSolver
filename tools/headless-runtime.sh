...
hr_acquire() {
    ...
    while :; do
        ...
        ((count < 2 && used_cpu + HR_CPU <= capacity_cpu && used_memory + HR_MEMORY <= total - 2048 && available - reserved_remaining >= HR_MEMORY + 2048)) || reason='host reservations full'
