...
foreach ($check in @(
    ...
    @{ Path = 'Cards\Silent\SilentPowerRoutePolicy.cs'; Text = 'internal readonly record struct SilentPowerRoutePolicy' },
    @{ Path = 'Cards\Silent\SilentPowerRouteAdmission.cs'; Text = 'internal static class SilentPowerRouteAdmission' },
