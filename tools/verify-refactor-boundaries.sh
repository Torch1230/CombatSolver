...
require_fixed "$repository_root/src/Engine/InCombat/Simulation/Compact/ResumableDiscardProgram.cs" 'ConsumeFreeEtherealPlay(card);' 'free ethereal uses must be consumed at card start'
