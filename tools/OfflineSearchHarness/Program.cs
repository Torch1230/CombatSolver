...
internal sealed record HarnessOptions
{
    public const string Usage = """
        用法：OfflineSearchHarness [选项]
          ...
          --encounter <id>       遭遇（无 --request 时用，默认 JAW_WORM）
    ...
    public HarnessScenario Scenario { get; init; } = new("IRONCLAD", "JAW_WORM", "OFFLINEHARNESS1", 0, 0);
    ...
    {
        string character = "IRONCLAD", encounter = "JAW_WORM", seed = "OFFLINEHARNESS1";
