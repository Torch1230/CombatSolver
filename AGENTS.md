...
> **当前工作重点（2026-09-12）：** `perf/surgical-fixes-20260912` 从上游 `eff8cf4` 建立，只做小范围、可独立验证的性能与 bug 修复。`perf/simulation-profile-20260910` 已暂停开发；不移植 Compact 后端、不重写战斗流程、不改变搜索预算或决策质量。此次是开发分支整理，不提升版本、不发包或上传。
