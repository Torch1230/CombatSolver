...
> **当前工作重点（2026-09-13）：** 本分支`test/generated-combat-scenarios-20260913`补充独立于玩家问题包的通用战斗场景生成工具：固定种子随机或逐项指定角色、A等级、初始牌组/遗物、追加角色牌/无色牌、遗物、药水及精英/Boss。复用无人测试建局/搜索/部署入口，保存解析后配置与实际建局证据；不修改求解政策，不混入PR #90/#91，不提升版本、不发包或上传。
