...
> **当前工作重点（2026-09-14）：** `main` 已整合 PR #90 与 PR #85–#88；本批审计并合入 PR #92 的通用战斗场景生成工具。该工具固定种子随机或逐项指定角色、A等级、初始牌组/遗物、追加角色牌/无色牌、遗物、药水及精英/Boss，复用无人测试建局/搜索/部署入口并保存解析后配置与实际建局证据；不修改求解政策，不提升版本、不发包或上传。
