...
| 要查什么 | 入口 |
|---|---|
| 下一版本的玩家更新日志草案 | [下一版本（开发中）](releases/NEXT-RELEASE_NOTES.md) |
...
| 搜索读数、执行高亮与窗口位置的玩家说明 | [0.45.0 更新日志](releases/0.45.0-RELEASE_NOTES.md) |
| 本批第三方回合开始适配、战斗预测修正与 Loadout 兼容的玩家说明 | [0.44.1 更新日志](releases/0.44.1-RELEASE_NOTES.md) |
