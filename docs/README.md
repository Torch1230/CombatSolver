...
| 自生成场景、上下文排序实验与组合达标早停 | [实验与取舍](strategy/contextual-ordering-20260922.md)、[早停证据](strategy/contextual-target-stop-20260922-evidence.json)、[权重敏感度证据](strategy/contextual-weight-sensitivity-20260922-evidence.json) |
