...
| 要查什么 | 入口 |
|---|---|
| 撤回Windows 4GB上限后的当前PR验证与未达成项 | [三组Windows对照](performance/no-gc-budget-restored-20260920.md) |
...
| GC恢复/回收所有权、异常完成链与36份最终组合对照 | [搜索内存生命周期重构](refactoring/search-memory-lifecycle-20260920.md) |
| Windows GC六场24份固定工作量对照、计算成本与暂停 | [多场景GC耗时验证](performance/windows-gc-multiscene-20260920.md) |
