...
| 要查什么 | 入口 |
|---|---|
| 可恢复选牌执行器草稿、成本与验收标准 | [独立设计](performance/resumable-choice-executor-design.md)、[调用链与实测](performance/resumable-choice-research-20260913.md)、[理论收益](performance/resumable-choice-benefit-20260913.md) |
