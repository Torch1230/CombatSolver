...
- 调整循环动作组的外观：次数移到动作右侧，收紧边框和留白，短循环与其他动作自然排列，窄面板内仍可换行。
...
- Made loop action groups more compact: the repeat count sits beside the actions, with a lighter frame and less padding. Short loops fit alongside other actions, while narrow panels still allow wrapping.
