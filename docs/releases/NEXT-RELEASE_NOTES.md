...
- 感谢 [ltlly](https://github.com/ltlly) 提交的 [PR #124](https://github.com/Torch1230/CombatSolver/pull/124)：找到满足已开启战损目标的完整路线后，更及时结束追加计算，同时保留成长、遗物、偷窃、用药目标和已知治疗机会的判断。调整默认搜索组合，减少重复计算并改善部分高压局面的路线；少数战斗可能比旧版略多受伤或多打一回合，并非每场战斗都会更快或找到更优路线。
