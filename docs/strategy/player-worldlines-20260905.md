...
| 3 | 58 HP | 61 → 3 | 待验证 | 待验证 | 跳过：整场软目标32 HP未验证（20260906）；184a9cd、start严格恢复；VeryHigh/DOP4、禁药、减战损优先长搜请求120秒超时；缩至20秒Short后仅中途预测6 HP、己75/敌313、未完战，无完整部署；证据`.local/checkpoint-batch/worldline-resume/rank3-search/`及`rank3-short-search/`，新政策首次搜索；历史22/20 HP仍为旧预测 | TEST_SUBJECT_BOSS | `CombatSolver-TEST_SUBJECT_BOSS-20260902-133704-483.zip` | `combatsolver-reports-20260905-104714.zip` | 打实验体不开壁垒吃重击的来 |
