...
| 12 | 35 HP | 51 → 16 | 待验证 | 待验证 | 开战预检通过；原包含空药水指令和两类 Boss 政策（均 ProgressionFirst），可按 Reported 运行，尚未做搜索 | KAISER_CRAB_BOSS | `CombatSolver-KAISER_CRAB_BOSS-20260904-231535-471.zip` | `combatsolver-reports-20260905-104412.zip` | 提示打不过boss，手动打了三个回合后计算就能打过了 |
