...
| 2 | 68 HP | 123 → 55 | 待验证 | 待验证 | 跳过：未达存活目标（20260906）；184a9cd、start严格恢复；按新要求High/180秒/DOP4、通关优先、仅稳定血清Force，预测仍死亡、HP0/敌194、1药（`06e30a3430da450ea4a601b71f4789f4`）；此前VeryHigh实际部署也Failed；证据`.local/checkpoint-batch/worldline-resume/rank2-high-search-resumed/`；High该根本构建首次完成搜索；历史50 HP不是当前验收 | AEONGLASS_BOSS | `CombatSolver-AEONGLASS_BOSS-20260903-152708-532.zip` | `combatsolver-reports-20260905-104714.zip` | 沙小第知道他自己打得过120血带药战士吗？ |
| 3 | 58 HP | 61 → 3 | 待验证 | 待验证 | 软目标达标（20260906）：184a9cd、start严格恢复，High/180秒/DOP4、禁药、减战损优先，预测/实际6 HP、0药、T6、余75 HP，目标32 HP，计划外重算0；证据`.local/checkpoint-batch/worldline-resume/rank3-high-deploy/`，`dbfded1e15bd465ab898a6d58f577040`；报告人工参考差-3，缺完整人工录制；首次High搜索来自本构建，部署缓存命中计数未采集；旧VeryHigh超时和Short未完战结果保留 | TEST_SUBJECT_BOSS | `CombatSolver-TEST_SUBJECT_BOSS-20260902-133704-483.zip` | `combatsolver-reports-20260905-104714.zip` | 打实验体不开壁垒吃重击的来 |
