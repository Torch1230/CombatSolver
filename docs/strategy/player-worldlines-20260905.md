...
| 7 | 45 HP | 50 → 5 | 待验证 | 待验证 | 开战预检通过；VeryHigh、MinimizeHpLoss、Smart 从 `000-combat_start` 得到完整胜利预测 23 HP（117.11 秒，runId `2b5b7786e5814054ac3f121bb98d3725`），仍高于人工 5 HP；根因定位为首回合 `TOASTY_MITTENS` 选牌人工取 `FOOTWORK`、求解器选了其他牌；首个保路试验未改善并在 High 诊断下退化至 65 HP（runId `8e258e4d6d144ecb9a787758c1ed8033`），已撤回；未做整场部署验收 | QUEEN_BOSS | `CombatSolver-QUEEN_BOSS-20260903-173813-639.zip` | `combatsolver-reports-20260905-104652.zip` | 不尊重灵动？ |
